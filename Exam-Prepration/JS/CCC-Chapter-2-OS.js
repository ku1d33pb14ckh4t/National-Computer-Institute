        ...
        // Exam state - TIMER CHANGED TO 1 HOUR 30 MINUTES (5400 seconds)
        const examState = {
            currentQuestion: 0,
            answers: new Array(questions.length).fill(null),
            timeRemaining: 5400, // 1 hour 30 minutes = 5400 seconds
            timerInterval: null,
            userPhoto: null,
            userName: "",
            userEmail: "",
        ...
        // Modified startExam function - Email optional, Name aur Phone required
        function startExam() {
            const fullName = document.getElementById('fullName').value;
            const phone = document.getElementById('phone').value;
            const email = document.getElementById('email').value || "Not Provided"; // Optional field
            ...
            // Scroll to top to show institute name
            window.scrollTo(0, 0);
        ...
        // Update progress indicators - Score ko real-time update nahi karega
        ...
        // Select an option - Score real-time update nahi hoga
